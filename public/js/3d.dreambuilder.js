(function () {
	...
	*/
	...
	var init = function () {
		...
		var t = THREE.ImageUtils.loadTexture( 'images/grass.jpg' );
	...
	var Roof = function (obj) {
		...
		var material = new THREE.MeshPhongMaterial({
			map: THREE.ImageUtils.loadTexture('images/roof.jpg')
		});
	...
	var Floor = function (obj) {
		...
		var t = THREE.ImageUtils.loadTexture( 'images/floor-tiles.jpg' );
		t.wrapS = t.wrapT = THREE.RepeatWrapping;
		var material = new THREE.MeshPhongMaterial({
			map: t
		});
	...
	var Wall = function (obj) {
		...
		var t = THREE.ImageUtils.loadTexture( 'images/wall-bricks.jpg' );
		t.wrapS = t.wrapT = THREE.RepeatWrapping;
		var material = new THREE.MeshPhongMaterial({
			map: t
		});
	...
	var Room = function (obj) {
		...
		var material = new THREE.MeshPhongMaterial({
			map: THREE.ImageUtils.loadTexture('images/room.jpg')
		});
		var mesh = new THREE.Mesh(geometry, material);
	...
	d.prototype.createWindow = function (obj) {
		...
		var geometry = new THREE.CubeGeometry(2, obj.width, obj.length);
		var material = new THREE.MeshPhongMaterial({
			map: THREE.ImageUtils.loadTexture('images/window.jpg')
		});
		var mesh = new THREE.Mesh(geometry, material);
