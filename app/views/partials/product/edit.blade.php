...
<form name="editProductForm" action="{{URL::to('product')}}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" value="{{$product->productID}}" name="productID" class="form-control" placeholder="CEM1234"><br>
    <label for="name">Name</label>
    <input type="text" value="{{$product->name}}" name="name" class="form-control" placeholder="Fox Cement"><br>
    ...
    <section class="input-group">
        ...
        <input type="text" value="{{$product->price}}" class="form-control" name="price" placeholder="143.00">
    </section><br>
